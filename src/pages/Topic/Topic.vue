    ...
    <div class="select_content">
      <div class="select_content_wrapper">
        ...
        <div class="select_content_list">
          ...
          <div class="select_content_product">
            <div class="select_product_pic" style="background-image:url(/static/images/HJ.jpg);background-size:cover;-webkit-background-size:cover;-o-background-size:cover;-ms-background-size:cover;-moz-background-size:cover;background-position:center;background-repeat:no-repeat;">
            </div>
  ...
  .select
    ...
    .select_content
      ...
      .select_content_wrapper
        width 100%
        .swiper-container
          padding-top (45*2 /$rem)
          width 100%
          ul
            width (1400*2 /$rem)
            height (200*2 /$rem)
            padding (10*2 /$rem) 0
            padding-left (50*2 /$rem)
            overflow hidden
            li
              position relative
              width (330*2 /$rem) !important
              height (200*2 /$rem)
              float left
              padding-left (10*2 /$rem)
              img
                border-radius (10*2 /$rem)
                width 100%
                height 100%
        ...
        .select_content_list
          ...
          .select_content_product
            ...
            .select_product_pic
              ...
              height (200*2 /$rem)
              span
                margin (5*2 /$rem) 0 0 (10*2 /$rem)
                display inline-block
                background-color #ffffff
                border 1px solid #ffffff
                line-height (16*2 /$rem)
                font-size (12*2 /$rem)
                padding 0 (10*2 /$rem)
                color black
                border-radius (10*2 /$rem)
          ...
          .select_content_food
            ...
            .select_food_text
              ...
              .select_food_text
                font-size (16*2 /$rem)
                margin-left (10*2 /$rem)
                line-height (75*2 /$rem)
          .select_food_pic
            float right
            width 40%
            height 100%
            p
              margin (2*2 /$rem) 0 0 (5*2 /$rem)
              display inline-block
              background-color #ffffff
              border (1*2 /$rem) solid #ffffff
              line-height (16*2 /$rem)
              font-size (12*2 /$rem)
              padding 0 (10*2 /$rem)
              color #333
